	...
	public static function getImages(&$params, $module_id){
		...
		while($i < 23) :
			...
			// if image + caption + title
					...
					$listitem = "<li class='".$text_shadow."-text-shadow'><div class='jslider-image'>".$link_image_before."<img title='' alt='".$params->get('image'.$i.'alt')."' src='".JURI::root().$params->get('image'.$i)."' /><span class='image-height-fixed' style='background-image: url(".JURI::root().$params->get('image'.$i).");'></span>".$link_image_after."</div><div class='slide-desc-box ".$position_text." ".$bg_caption_shadow."-shadow ".$anim_text."' ><div ".$fadeText."><div class='".$bg_text."' ><h3 class='slide-title'  style='max-width:".$max_width."px;color:".$color_title.";font-size:".$font_size_title.";'><span class='span-js-title'>".$params->get('image'.$i.'title')."</span></h3><div class='slide-desc' style='max-width:".$max_width."px;color:".$color_text.";font-size:".$font_size_text.";'><span>".$params->get('image'.$i.'cap')."</span>".$link."</div></div></div></div></li>";
					array_push($imgsAndCaps, $listitem);	
			...
			// if image + no caption + title
					...
					$listitem = "<li class='".$text_shadow."-text-shadow'><div class='jslider-image'>".$link_image_before."<img title='' alt='".$params->get('image'.$i.'alt')."' src='".JURI::root().$params->get('image'.$i)."' /><span class='image-height-fixed' style='background-image: url(".JURI::root().$params->get('image'.$i).");'></span>".$link_image_after."</div><div class='slide-desc-box ".$position_text." ".$bg_caption_shadow."-shadow ".$anim_text."' ><div ".$fadeText."><div class='".$bg_text."' ><h3 class='slide-title' style='max-width:".$max_width."px;color:".$color_title.";font-size:".$font_size_title.";'><span class='span-js-title'>".$params->get('image'.$i.'title')."</span></h3>".$link."</div></div></div></li>";
					array_push($imgsAndCaps, $listitem);
			}
