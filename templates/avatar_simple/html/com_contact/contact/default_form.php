...
<div class="contact-form">
	<form id="contact-form" action="<?php echo JRoute::_('index.php'); ?>" method="post" class="form-validate">
		<fieldset>
			<legend><?php  echo JText::_('COM_CONTACT_EMAIL_FORM'); ?></legend>
			<dl>
				...
				<?php 	if ($this->params->get('show_email_copy')){ ?>
						...
						<dd class="send-copy"><?php echo $this->form->getLabel('contact_email_copy'); ?><?php echo $this->form->getInput('contact_email_copy'); ?></dd>
				<?php 	} ?>
			<?php //Dynamically load any additional fields from plugins. ?>
			     ...
			     <?php endforeach;?>
				<dt></dt>
				<dd class="button"><button class="btn validate" type="submit"><?php echo JText::_('COM_CONTACT_CONTACT_SEND'); ?></button>
